...
public:
    ...
    iterator find(neighbour_type* neighbour) {
        return find(BaseLink(neighbour));
    }
    iterator find(TO* to) {
        return find(neighbour_type::from_host(to));
    }
    ...
    void erase(neighbour_type* neighbour) {
        erase(BaseLink(neighbour));
    }
    void erase(TO* to) {
        erase(neighbour_type::from_host(to));
    }
    ...
    void set(neighbour_type* neighbour) {
        set(BaseLink(neighbour));
    }
    void set(TO* to) {
        set(neighbour_type::from_host(to));
    }
